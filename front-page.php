        ...
        <div class="glide__slides">
          ...
          <?php
            ...
            while($homepageSlideshow->have_posts()) {
              ...
              <div class="hero-slider__slide" style="background-image: url(<?php echo esc_url($slideImage); ?>);">
                <div class="hero-slider__interior container">
                  <div class="hero-slider__overlay">
                    <h2 class="headline headline--medium t-center"><?php echo esc_html($slideTitle); ?></h2>
                    <p class="t-center"><?php echo esc_html($slideSubtitle); ?></p>
                    <p class="t-center no-margin"><a href="<?php the_permalink(); ?>" class="btn btn--blue"><?php echo esc_html($slideLinkText); ?></a></p>
                  </div>
                </div>
              </div>
